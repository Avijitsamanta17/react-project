 ...
 const navigate = useNavigate();
  ...
  const userProfileGet = async()=>{
    ...
    if(response.status === 200){
      ...
      setDefaultValueSelect(response.data.semester);
    }else{
      console.log("error");
    }
  }
  ...
  const submitUserData = async(e) => {
    ...
    if (fname === "") {
      ...
      data.append("semester",defaultValueSelect)
          ...
          <Card className='shadow mt-3 p-3'>
            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  <Form.Label>Select Your Semester</Form.Label>

                  <Form.Control type="text" disabled name='semester' value={semester}  />

                  <Form.Control as="select" value={defaultValueSelect} onChange={setSemesterValue}>
